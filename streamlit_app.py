...
st.title("Dr. Z.C.M.")
st.title("Construction of chronic pain prediction model after femoral hernia operation based on intelligent algorithm")  # 算法名称 and XXX
...
def do_processing():
    ...
    # 准备模型
    lsvc = LinearSVC(penalty='l2', loss='squared_hinge', dual=True, tol=0.0001, C=1.0, multi_class='ovr', fit_intercept=True,
